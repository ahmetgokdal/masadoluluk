...
curl -X GET "http://localhost:8001/api/cabins" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
...
## Checklist
- [ ] User document has _id field in MongoDB
- [ ] Session user_id matches user's _id value exactly
- [ ] Both use string IDs (not ObjectId)
- [ ] Pydantic models handle _id mapping via Field(alias="_id")
